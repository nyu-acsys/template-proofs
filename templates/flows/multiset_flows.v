...
Definition keyset I n := dom (inf I n) ∖ (outsets I).
...
Proof.
  unfold out.
  intros.
  rewrite (inflow_map_set_out_eq (λ _ n, n + 1) I n S I').
  trivial. trivial.
Qed.
...
Proof.
  unfold inset.
  pose proof (outflow_map_set_inf (λ _ n, n + 1) I n S I').
...
Proof.
  unfold inset.
  pose proof (inflow_map_set_ne (λ _ n, n + 1) I n S I' n').
  intros.
  unfold inf.
  rewrite H0; done.
Qed.
