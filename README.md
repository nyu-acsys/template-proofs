...
The artifact can be generated by running `./create_oopsla_artifact.sh` (see Step-by-step Setup Guide below for more details). It is also packaged as a VirtualBox Image uploaded to Zenodo and available [here](https://doi.org/10.5281/zenodo.5496104). 
